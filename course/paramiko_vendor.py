# From
# https://github.com/jelmer/dulwich/blob/4decf4e9254a5b163bbfa3a8188c332dedb8d322/contrib/paramiko_vendor.py
# with changes to make the host key policy configurable.
...
class ParamikoSSHVendor:
    ...
    def __init__(
        ...
        **kwargs: object,
        ...
        Args:
            missing_host_key_policy: Host key policy to use when connecting
                to a host whose key is not in known_hosts.
                Defaults to ``paramiko.RejectPolicy()`` (fail-closed).
                Pass ``paramiko.AutoAddPolicy()`` to disable checking.
    ...
    def run_command(
        ...
        **kwargs: object,
        ...
        policy = (
            ...
            if self.missing_host_key_policy is not None
