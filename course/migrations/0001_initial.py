    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('git_source', models.CharField(help_text=b"A Git URL from which to pull course updates. If you're just starting out, enter <tt>git://github.com/inducer/coursely-sample</tt> to get some sample content.", max_length=200, blank=True)),
                ...
                ('email', models.EmailField(help_text=b"This email address will be used in the 'From' line of automated emails sent by Coursely. It will also receive notifications about required approvals.", max_length=75)),
