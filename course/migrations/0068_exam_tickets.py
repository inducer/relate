    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(verbose_name='Course', to='course.Course')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exam', models.ForeignKey(verbose_name='Exam', to='course.Exam')),
                ('participation', models.ForeignKey(verbose_name='Participation', to='course.Participation')),
            ],
            options={
