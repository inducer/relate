# -*- coding: utf-8 -*-
#
# coursely documentation build configuration file, created by
...
latex_documents = [
  ('index', 'coursely.tex', u'coursely Documentation',
...
man_pages = [
    ('index', 'coursely', u'coursely Documentation',
...
texinfo_documents = [
  ('index', 'coursely', u'coursely Documentation',
   u'Andreas Kloeckner', 'coursely', 'One line description of project.',
   'Miscellaneous'),
]
